...
```
cd existing_repo
git remote add origin https://gitlab.com/tactic4/app/e-commerce.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/tactic4/app/e-commerce/-/settings/integrations)
